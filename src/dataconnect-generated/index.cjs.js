...
const getProjectsForUserRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetProjectsForUser', inputVars);
}
getProjectsForUserRef.operationName = 'GetProjectsForUser';
exports.getProjectsForUserRef = getProjectsForUserRef;

exports.getProjectsForUser = function getProjectsForUser(dcOrVars, vars) {
  return executeQuery(getProjectsForUserRef(dcOrVars, vars));
};
